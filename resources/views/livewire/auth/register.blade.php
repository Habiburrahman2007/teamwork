                    ...
                    <div class="container z-10">
                        <div class="flex flex-wrap justify-center -mx-3">
                            <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                                ...
                                <p class="text-white">A collection of moments, light, and emotions captured through my
                                    lens.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="flex-auto p-6">
                                    <form wire:submit.prevent="register">
                                                ...
                                                <svg x-show="show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112
                                                            ...
                                                            a9.97 9.97 0 012.986-4.28M9.88
                                        ...
                                        <p class="mt-4 mb-0 text-sm text-center">Already have an account?
                                            <a href="{{ route('login') }}" class="font-bold text-slate-700">Sign
                                                in</a>
                                        </p>
                                    </form>
                                </div>
