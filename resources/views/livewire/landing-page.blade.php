                    ...
                    <div class="group cursor-pointer">
                        <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                            <img src="{{ $portfolio->image_url ? asset('storage/' . $portfolio->image_url) : 'https://via.placeholder.com/400x200' }}"
                                alt="Project Image" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">>
                        ...
                        <div class="flex gap-2">
                            ...
                            <span
                                class="text-xs px-3 py-1 bg-gray-100 text-gray-700 rounded-full">{{ $portfolio->category->name }}</span>
                        </div>
                    </div>
                @endforeach
