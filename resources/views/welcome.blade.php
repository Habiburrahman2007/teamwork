        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-4">
                    <a href="/login"
                        class="hidden sm:inline-block text-sm text-gray-600 hover:text-primary transition-colors">Masuk</a>
                    <a href="/register"
                        class="bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-secondary transition-colors">Daftar</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="max-w-3xl">
                ...
                <p class="text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl">
                    Platform katalog portofolio modern yang membantu Anda mengorganisir, mengelola, dan memamerkan
                    karya-karya terbaik Anda dengan tampilan yang profesional dan elegan.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#"
                        class="inline-flex items-center justify-center bg-primary text-white px-8 py-3 rounded-lg font-medium hover:bg-secondary transition-colors">
                        Mulai Sekarang
                    </a>
                    <a href="#showcase"
                        class="inline-flex items-center justify-center border border-gray-300 text-primary px-8 py-3 rounded-lg font-medium hover:border-primary transition-colors">
                        Lihat Demo
                    </a>
                </div>
            </div>
    ...
    <section id="fitur" class="py-20 px-4 sm:px-6 lg:px-8 bg-light">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Semua yang Anda butuhkan untuk membuat katalog portofolio
                    yang menakjubkan</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600 leading-relaxed">Tampilkan karya Anda dalam galeri yang indah dengan tata
                        letak yang responsif dan modern.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600 leading-relaxed">Organisir proyek Anda dengan sistem tag dan kategori yang
                        fleksibel dan mudah digunakan.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600 leading-relaxed">Portofolio Anda terlihat sempurna di semua perangkat, dari
                ...
                <div class="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600 leading-relaxed">Loading cepat dan performa optimal untuk pengalaman
                        pengguna yang terbaik.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600 leading-relaxed">Kelola semua proyek Anda dalam satu tempat dengan antarmuka
                        yang intuitif.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600 leading-relaxed">Bagikan portofolio Anda dengan mudah melalui link yang
                        dapat dikustomisasi.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group cursor-pointer">
                    <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                        <img src="/placeholder.svg?height=400&width=600" alt="Project 1"
                ...
                <div class="group cursor-pointer">
                    <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                        <img src="/placeholder.svg?height=400&width=600" alt="Project 2"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                        <div class="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors"></div>
                    </div>
                ...
                <div class="group cursor-pointer">
                    <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                        <img src="/placeholder.svg?height=400&width=600" alt="Project 3"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                        <div class="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors"></div>
                    </div>
                ...
                <div class="group cursor-pointer">
                    <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                        <img src="/placeholder.svg?height=400&width=600" alt="Project 4"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                        <div class="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors"></div>
                    </div>
                ...
                <div class="group cursor-pointer">
                    <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                        <img src="/placeholder.svg?height=400&width=600" alt="Project 5"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                        <div class="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors"></div>
                    </div>
                ...
                <div class="group cursor-pointer">
                    <div class="relative overflow-hidden rounded-xl bg-gray-100 aspect-[4/3] mb-4">
                        <img src="/placeholder.svg?height=400&width=600" alt="Project 6"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                        <div class="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors"></div>
                    </div>
    ...
    <section id="tentang" class="py-20 px-4 sm:px-6 lg:px-8 bg-light">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl sm:text-4xl font-bold text-primary mb-6 text-balance">Mengapa memilih
                        PortfolioCatalog?</h2>
                    <p class="text-gray-600 leading-relaxed mb-6">
                        Kami memahami bahwa portofolio adalah representasi dari karya dan profesionalisme Anda.
                        PortfolioCatalog dirancang untuk memberikan Anda kontrol penuh atas bagaimana karya Anda
                        ditampilkan.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-8">
                        Dengan antarmuka yang intuitif dan fitur-fitur canggih, Anda dapat fokus pada apa yang Anda
                        lakukan terbaik - menciptakan karya luar biasa - sementara kami menangani sisanya.
                    </p>
                    <div class="space-y-4">
                ...
                <div class="relative">
                    <div class="aspect-square rounded-2xl bg-gradient-to-br from-accent/20 to-primary/20 p-8">
                        <div class="w-full h-full bg-white rounded-xl shadow-2xl flex items-center justify-center">
                            <img src="/placeholder.svg?height=500&width=500" alt="Dashboard Preview"
    ...
    <section id="kontak" class="py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Bergabunglah dengan ribuan profesional kreatif yang telah mempercayai PortfolioCatalog untuk menampilkan
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <p class="text-gray-300 text-sm leading-relaxed">Platform katalog portofolio modern untuk
                        profesional kreatif.</p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Template</a>
                        </li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Integrasi</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Tentang
                                Kami</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Pusat
                                Bantuan</a></li>
